...
| [deft-directive-design-critique](./content/skills/deft-directive-design-critique/SKILL.md) | Thin router into the design-critique contract: five pointer stops; operator dispatches from the brief template. | `design critique`, `design-critique`, `critique panel`, `mechanism-shaped triage` |
