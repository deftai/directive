...
Refs: #3145 · #3205 · Related: #1310, #2944 human-origin grants, #516 file scope · generalizes under [gate-integrity.md](./gate-integrity.md) (#3156) · UI structure: [observable-scope.md](./observable-scope.md) (#4495)
...
First adoption (no prior approval) uses the default kind:

```bash
deft scope:record-approved-scope -- <xbrief-path> --actor <you> --confirm
```

Later expansion remint after a first human mint reserves `--kind renewed-approval`:
