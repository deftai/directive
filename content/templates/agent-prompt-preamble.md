...
- ⊗ Parent-inline residual when dest spawn is available for Grok through-merge (#4821). Dest spawn deny is `BLOCKED` or dest-cwd residual (#4215), not parent-primary.
