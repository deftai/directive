...
## bug(triage,skills): task triage:welcome silently skips bootstrap; candidates.jsonl remains absent (#1244)
...
## bug(triage,determinism): verify:cache-fresh false-fails on backfill-only cache state (#1245)
