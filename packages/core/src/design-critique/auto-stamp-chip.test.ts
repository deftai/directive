/**
 * Completed-arc record drives auto-stamp chip (#4298). Recut: is a lean token,
 * not a chip selector. No NLP of lean prose.
 */
...
describe("resolveAutoStampCatalogChip (#4298)", () => {
  ...
  it("detects Recut: as a line-start in all nine spellings without selecting a chip", () => {
  ...
  it("does not treat Recut: inside a Lean: line as the closed token", () => {
    ...
    expect(resolveAutoStampCatalogChip(body)).toBe("design-critique:ingest-ready");
  });
