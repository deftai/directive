...
describe("test_contracts.py", () => {
  ...
  it("refs ./core/glossary.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "core/glossary.md"),
      ),
    ).toBe(true);
  });
  it("refs ./coding/coding.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "coding/coding.md"),
      ),
    ).toBe(true);
  });
  it("refs ./languages/python.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/python.md"),
      ),
    ).toBe(true);
  });
  ...
  it("refs ./languages/typescript.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/typescript.md"),
      ),
    ).toBe(true);
  });
  it("refs ./languages/officejs.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/officejs.md"),
      ),
    ).toBe(true);
  });
  it("refs ./languages/cpp.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/cpp.md"),
      ),
    ).toBe(true);
  });
  it("refs ./languages/vba.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/vba.md"),
      ),
    ).toBe(true);
  });
  it("refs ./vbrief/vbrief.md#project-definitionvbriefjson", () => {
    expect(
      existsSync(
        join(repoRoot(), "vbrief/vbrief.md"),
      ),
    ).toBe(true);
  });
  it("refs ./interfaces/cli.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "interfaces/cli.md"),
      ),
    ).toBe(true);
  });
  it("refs ./interfaces/rest.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "interfaces/rest.md"),
      ),
    ).toBe(true);
  });
  it("refs ./interfaces/tui.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "interfaces/tui.md"),
      ),
    ).toBe(true);
  });
  it("refs ./interfaces/web.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "interfaces/web.md"),
      ),
    ).toBe(true);
  });
  it("refs ./deployments/README.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "deployments/README.md"),
      ),
    ).toBe(true);
  });
  it("refs ./scm/git.md", () => {
  ...
  it("refs ./tools/taskfile.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "tools/taskfile.md"),
      ),
    ).toBe(true);
  });
  it("refs ./coding/testing.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "coding/testing.md"),
      ),
    ).toBe(true);
  });
  it("refs ./coding/security.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "coding/security.md"),
      ),
    ).toBe(true);
  });
  it("refs ./tools/telemetry.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "tools/telemetry.md"),
      ),
    ).toBe(true);
  });
  ...
  it("refs ./patterns/llm-app.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "patterns/llm-app.md"),
      ),
    ).toBe(true);
  });
  it("refs ./patterns/role-as-overlay.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "patterns/role-as-overlay.md"),
      ),
    ).toBe(true);
  });
  it("refs ./patterns/prompt-assembly-layer-ordering.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "patterns/prompt-assembly-layer-ordering.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/context.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/context.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/working-memory.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/working-memory.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/long-horizon.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/long-horizon.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/tool-design.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/tool-design.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/deterministic-split.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/deterministic-split.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/fractal-summaries.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/fractal-summaries.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/examples.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/examples.md"),
      ),
    ).toBe(true);
  });
  it("refs ./verification/verification.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "verification/verification.md"),
      ),
    ).toBe(true);
  });
  it("refs ./verification/uat.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "verification/uat.md"),
      ),
    ).toBe(true);
  });
  it("refs ./verification/plan-checking.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "verification/plan-checking.md"),
      ),
    ).toBe(true);
  });
  it("refs ./verification/integration.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "verification/integration.md"),
      ),
    ).toBe(true);
  });
  it("refs ./resilience/continue-here.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "resilience/continue-here.md"),
      ),
    ).toBe(true);
  });
  it("refs ./resilience/context-pruning.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "resilience/context-pruning.md"),
      ),
    ).toBe(true);
  });
  it("refs ./contracts/boundary-maps.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "contracts/boundary-maps.md"),
      ),
    ).toBe(true);
  });
  it("refs ./strategies/discuss.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/discuss.md"),
      ),
    ).toBe(true);
  });
  it("refs ./strategies/map.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/map.md"),
      ),
    ).toBe(true);
  });
  it("refs ./strategies/research.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/research.md"),
      ),
    ).toBe(true);
  });
  it("refs ./core/glossary.md", () => {
  ...
  it("refs ./history/README.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "history/README.md"),
      ),
    ).toBe(true);
  });
  it("refs ./context/spec-deltas.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "context/spec-deltas.md"),
      ),
    ).toBe(true);
  });
  it("refs ./templates/make-spec.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "templates/make-spec.md"),
      ),
    ).toBe(true);
  });
  ...
  it("refs ./vbrief/schemas/vbrief-core.schema.json", () => {
    expect(
      existsSync(
        join(repoRoot(), "vbrief/schemas/vbrief-core.schema.json"),
      ),
    ).toBe(true);
  });
  ...
  it("refs ./meta/code-field.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "meta/code-field.md"),
      ),
    ).toBe(true);
  });
  ...
  it("refs ./meta/suggestions.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "meta/suggestions.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./interview.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/interview.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./yolo.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/yolo.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./speckit.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/speckit.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/./probe.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/probe.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/./roadmap.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/roadmap.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./bdd.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/bdd.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./rapid.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/rapid.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./enterprise.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/enterprise.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/./v0-20-contract.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/v0-20-contract.md"),
      ),
    ).toBe(true);
  });
  it("strategies/./v0-20-contract.md", () => {
  ...
  it("coding/security.md::hygiene.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "coding/hygiene.md"),
      ),
    ).toBe(true);
  });
  ...
  it("coding/security.md::../incidents/README.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "incidents/README.md"),
      ),
    ).toBe(true);
  });
  ...
  it("contracts/deterministic-questions.md::../skills/deft-directive-interview/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-interview/SKILL.md"),
      ),
    ).toBe(true);
  });
  it("contracts/deterministic-questions.md::../vbrief/completed/2026-04-20-431-deterministic-questions-rc2-defects.vbrief.json", () => {
    expect(
      existsSync(
        join(repoRoot(), "vbrief/completed/2026-04-20-431-deterministic-questions-rc2-defects.vbrief.json"),
      ),
    ).toBe(true);
  });
  ...
  it("contracts/hierarchy.md::../meta/philosophy.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "meta/philosophy.md"),
      ),
    ).toBe(true);
  });
  ...
  it("conventions/task-caching.md::../tests/content/test_taskfile_caching.py", () => {
    expect(
      existsSync(
        join(repoRoot(), "tests/content/test_taskfile_caching.py"),
      ),
    ).toBe(true);
  });
  ...
  it("conventions/vbrief-filenames.md::./references.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "conventions/references.md"),
      ),
    ).toBe(true);
  });
  ...
  it("deployments/cloudflare/via-dashboard.md::./README.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "deployments/cloudflare/README.md"),
      ),
    ).toBe(true);
  });
  it("deployments/cloudflare/via-dashboard.md::./via-git.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "deployments/cloudflare/via-git.md"),
      ),
    ).toBe(true);
  });
  it("deployments/cloudflare/via-dashboard.md::./via-wrangler.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "deployments/cloudflare/via-wrangler.md"),
      ),
    ).toBe(true);
  });
  ...
  it("deployments/cloudflare/via-git.md::./via-github-actions.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "deployments/cloudflare/via-github-actions.md"),
      ),
    ).toBe(true);
  });
  ...
  it("docs/ARCHITECTURE.md::./code-structure-profile.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "docs/code-structure-profile.md"),
      ),
    ).toBe(true);
  });
  it("docs/ARCHITECTURE.md::./codebase-map-source-of-truth.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "docs/codebase-map-source-of-truth.md"),
      ),
    ).toBe(true);
  });
  ...
  it("docs/FILES.md::./RELEASING.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "docs/RELEASING.md"),
      ),
    ).toBe(true);
  });
  ...
  it("docs/versioning.md::../scm/changelog.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "scm/changelog.md"),
      ),
    ).toBe(true);
  });
  ...
  it("docs/versioning.md::../skills/deft-directive-release/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-release/SKILL.md"),
      ),
    ).toBe(true);
  });
  ...
  it("languages/mermaid.md::./markdown.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/markdown.md"),
      ),
    ).toBe(true);
  });
  ...
  it("meta/philosophy.md::../contracts/hierarchy.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "contracts/hierarchy.md"),
      ),
    ).toBe(true);
  });
  ...
  it("platforms/unity.md::../languages/csharp.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "languages/csharp.md"),
      ),
    ).toBe(true);
  });
  it("references/composer-skill-porting.md::../skills/deft-directive-write-skill/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-write-skill/SKILL.md"),
      ),
    ).toBe(true);
  });
  ...
  it("references/ip-risk.md::../scripts/ip_risk.py", () => {
    expect(
      existsSync(
        join(repoRoot(), "scripts/ip_risk.py"),
      ),
    ).toBe(true);
  });
  ...
  it("scm/changelog.md::../core/versioning.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "core/versioning.md"),
      ),
    ).toBe(true);
  });
  ...
  it("skills/deft-directive-decompose/SKILL.md::../deft-directive-swarm/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-swarm/SKILL.md"),
      ),
    ).toBe(true);
  });
  it("skills/deft-directive-pre-pr/SKILL.md::../deft-directive-review-cycle/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-review-cycle/SKILL.md"),
      ),
    ).toBe(true);
  });
  it("skills/deft-directive-pre-pr/SKILL.md::../deft-directive-build/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-build/SKILL.md"),
      ),
    ).toBe(true);
  });
  ...
  it("skills/deft-directive-refinement/SKILL.md::../../contracts/deterministic-questions.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "contracts/deterministic-questions.md"),
      ),
    ).toBe(true);
  });
  ...
  it("skills/deft-directive-release/SKILL.md::../deft-directive-refinement/SKILL.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "skills/deft-directive-refinement/SKILL.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/emit-hints.md::./artifact-guards.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/artifact-guards.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/enterprise.md::./README.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "strategies/README.md"),
      ),
    ).toBe(true);
  });
  ...
  it("strategies/v0-20-contract.md::../scripts/migrate_vbrief.py", () => {
    expect(
      existsSync(
        join(repoRoot(), "scripts/migrate_vbrief.py"),
      ),
    ).toBe(true);
  });
  it("strategies/v0-20-contract.md::../conventions/machine-generated-banner.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "conventions/machine-generated-banner.md"),
      ),
    ).toBe(true);
  });
  ...
  it("swarm/swarm.md::../meta/security.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "meta/security.md"),
      ),
    ).toBe(true);
  });
  ...
  it("tools/taskfile.md::./taskfile-migration.md", () => {
    expect(
      existsSync(
        join(repoRoot(), "tools/taskfile-migration.md"),
      ),
    ).toBe(true);
  });
